...
const CountryDropDown = ({setValue,attribute}) =>{
    return(
    <FormControl fullWidth>
        <InputLabel id="place-country">Place</InputLabel>

    <Select
        required
        id="place-country"
        label="select country"
        onChange={(e)=>{setValue((current)=>{
            let newVal = {...current};
            newVal[attribute] = e.target.value;
            return newVal;
        })}}
        // onChange={(e) => {handleChange(e,setUserPlaceChoice,0)}}
                >
        ...
        <MenuItem value="Lebanon" selected>Lebanon</MenuItem>
